...
public class AutoLeftRed extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence cycle1 = drivetrain.trajectorySequenceBuilder(preload.end())
                ...
                .splineToLinearHeading(new Pose2d(AutoRightBlue.intakePose2XFirstCone, -AutoRightBlue.intakePose2YFirstCone, Math.toRadians(AutoRightBlue.intakeAngle)), Math.toRadians(0))
        ...
        TrajectorySequence cycle2 = drivetrain.trajectorySequenceBuilder(place1.end())
                .setReversed(true)
                .splineToSplineHeading(new Pose2d(AutoRightBlue.intakePoseCycleXSecondCone, -AutoRightBlue.intakePose1YSecondCone, Math.toRadians(AutoRightBlue.intakeAngle)), Math.toRadians(0))
        ...
        TrajectorySequence cycle3 = drivetrain.trajectorySequenceBuilder(place2.end())
                .setReversed(true)
                .splineToSplineHeading(new Pose2d(AutoRightBlue.intakePoseCycleXThirdCone, -AutoRightBlue.intakePose1YThirdCone, Math.toRadians(AutoRightBlue.intakeAngle)), Math.toRadians(0))
