...
public class AutoRightRed extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence preload = drivetrain.trajectorySequenceBuilder(startPose)
                .strafeRight(AutoRightBlue.startConeStrafe1, velConstraint, accelConstraint)
                .strafeLeft(AutoRightBlue.startConeStrafe2, velConstraint, accelConstraint)
        ...
        TrajectorySequence place1 = drivetrain.trajectorySequenceBuilder(cycle1.end())
                ...
                .splineTo(new Vector2d(-AutoRightBlue.posCone2XFirstCone, -AutoRightBlue.posCone2YFirstCone), Math.toRadians(- AutoRightBlue.posConeAngle + 90))
                .waitSeconds(DELIVERY_WAIT_TIME)
                .addTemporalMarker(autoCommands.goDownToReleaseCone())
                .waitSeconds(ALMOST_RELEASE_TIME)
                .addTemporalMarker(autoCommands.releaseCone())
        ...
        TrajectorySequence place2 = drivetrain.trajectorySequenceBuilder(cycle2.end())
                .lineTo(new Vector2d(-AutoRightBlue.posCone1X, -AutoRightBlue.posCone1Y))
                .addTemporalMarker(autoCommands.readyToRelease())
                .splineTo(new Vector2d(-AutoRightBlue.posCone2XSecondCone, -AutoRightBlue.posCone2YSecondCone), Math.toRadians(-AutoRightBlue.posConeAngle - 90))
                .waitSeconds(DELIVERY_WAIT_TIME)
                .addTemporalMarker(autoCommands.goDownToReleaseCone())
                .waitSeconds(ALMOST_RELEASE_TIME)
                .addTemporalMarker(autoCommands.releaseCone())
        ...
        TrajectorySequence place3 = drivetrain.trajectorySequenceBuilder(cycle3.end())
                .lineTo(new Vector2d(-AutoRightBlue.posCone1X, -AutoRightBlue.posCone1Y))
                .addTemporalMarker(autoCommands.readyToRelease())
                .splineTo(new Vector2d(-AutoRightBlue.posCone2XThirdCone, -AutoRightBlue.posCone2YThirdCone), Math.toRadians(-AutoRightBlue.posConeAngle - 90))
                .waitSeconds(DELIVERY_WAIT_TIME)
                .addTemporalMarker(autoCommands.goDownToReleaseCone())
                .waitSeconds(ALMOST_RELEASE_TIME)
                .addTemporalMarker(autoCommands.releaseCone())
        ...
        TrajectorySequence park1 = drivetrain.trajectorySequenceBuilder(place3.end())
                ...
                .lineToLinearHeading(new Pose2d(AutoRightBlue.parkPoseX, -AutoRightBlue.parkPoseY, Math.toRadians(0)),velConstraint,accelConstraint)
